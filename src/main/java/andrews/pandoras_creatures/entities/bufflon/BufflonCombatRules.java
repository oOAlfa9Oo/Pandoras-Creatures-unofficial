...
public final class BufflonCombatRules {
    ...
    public static float getAdjustedIncomingDamage(@Nullable Entity attacker, float amount) {
    ...
    public static BufflonCombatTargetProfile describeTarget(LivingEntity target, LivingEntity owner) {
        return new BufflonCombatTargetProfile(
                ...
                target instanceof BufflonEntity bufflon && bufflon.isTamed() && bufflon.getOwner() == owner,
