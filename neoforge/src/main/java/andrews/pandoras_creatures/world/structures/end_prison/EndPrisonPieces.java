...
public class EndPrisonPieces {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(StructureTemplateManager templateManager, BlockPos position, Rotation rotation) {
            super(
                PCStructures.END_PRISON_PIECE.get(),
                0,
                templateManager,
                SHIP_TEMPLATE,
        ...
        public void postProcess(WorldGenLevel level, StructureManager structureManager, ChunkGenerator generator, RandomSource random, BoundingBox box, ChunkPos chunkPos, BlockPos pos) {
            ...
            // The preserved ship template already contains the correct chests/entities from 1.16.5.
            // Re-seed loot tables here so each generated ship does not share the same baked-in loot.
