...
public final class PCBiomeModifierDataProvider implements DataProvider {
    ...
    private static CompletableFuture<?> saveFeatureModifier(CachedOutput cachedOutput, PackOutput.PathProvider pathProvider,
                                                            String modifierNamespace, PCBiomeFeatureCatalog.FeatureDefinition definition) {
    ...
    private static JsonObject createFeatureModifier(String modifierNamespace, PCBiomeFeatureCatalog.FeatureDefinition definition) {
        JsonObject root = new JsonObject();
