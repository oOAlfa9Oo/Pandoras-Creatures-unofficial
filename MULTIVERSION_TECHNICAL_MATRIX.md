...
| 26.1 | Java 25 requerido para Gradle JVM | Gradle 9.4.0 recomendado | Loader 0.19.1, API 0.145.1+26.1, Loom 1.16.1 | Forge 26.1-62.0.9 | NeoForge 26.1.0.19-beta experimental | Official/unobfuscated 26.1 | Fabric build spike |
