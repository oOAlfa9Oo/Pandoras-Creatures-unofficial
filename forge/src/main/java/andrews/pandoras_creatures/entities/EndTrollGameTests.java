...
public final class EndTrollGameTests {
    ...
    public static void saveDataRestoresStandingAndScreamState(GameTestHelper helper) {
        EndTrollEntity endTroll = helper.spawn(PCForgeEntities.endTroll(), END_TROLL_POS);
        ...
        EndTrollEntity restored = new EndTrollEntity(PCForgeEntities.endTroll(), helper.getLevel());
