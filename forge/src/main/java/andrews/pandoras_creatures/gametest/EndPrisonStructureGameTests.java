...
/**
 * Valida en un servidor real (host forge) que la estructura End Prison
 * se carga desde datapack y puede generarse de verdad (jigsaw + piezas).
 * Sirve ademas de validacion runtime del ADR-0008 (forge consume common output).
 *
 * Sin @GameTestDontPrefix: Forge 52 filtra forge.enabledGameTestNamespaces contra el
 * NOMBRE del test (startsWith "<ns>."), que solo pasa con el prefijo del holder.
 * El template lleva namespace explicito para que el prefijo no lo altere.
 */
