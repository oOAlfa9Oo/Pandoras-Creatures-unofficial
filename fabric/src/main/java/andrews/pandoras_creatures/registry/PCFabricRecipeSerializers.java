...
public final class PCFabricRecipeSerializers {
    ...
    public static void register() {
        register(PCRecipeIds.END_TROLL_BOX, EndTrollBoxRecipe.serializer());
        register(PCRecipeIds.END_TROLL_BOX_COLORING, EndTrollBoxColoringRecipe.serializer());
    }

    private static <T extends RecipeSerializer<?>> T register(String path, T serializer) {
        return Registry.register(
                BuiltInRegistries.RECIPE_SERIALIZER,
                Identifier.fromNamespaceAndPath(Reference.MODID, path),
                serializer);
    }
}
