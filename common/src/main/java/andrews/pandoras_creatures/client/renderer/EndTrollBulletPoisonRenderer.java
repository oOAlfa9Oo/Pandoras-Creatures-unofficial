...
public class EndTrollBulletPoisonRenderer extends EntityRenderer<EndTrollBulletPoisonEntity> {
    private static final Identifier END_TROLL_BULLET_TEXTURE = Identifier.fromNamespaceAndPath(Reference.MODID, "textures/entity/end_troll/bullets/end_troll_bullet_2.png");
    ...
    @Override
    public Identifier getTextureLocation(EndTrollBulletPoisonEntity entity) {
