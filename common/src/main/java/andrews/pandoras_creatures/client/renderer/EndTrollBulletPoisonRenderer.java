...
public class EndTrollBulletPoisonRenderer extends EntityRenderer<EndTrollBulletPoisonEntity, EndTrollBulletRenderState> {
    ...
    @Override
    public void extractRenderState(EndTrollBulletPoisonEntity entity, EndTrollBulletRenderState state, float partialTick) {
