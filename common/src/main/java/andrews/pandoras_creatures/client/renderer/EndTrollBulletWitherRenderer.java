...
public class EndTrollBulletWitherRenderer extends EntityRenderer<EndTrollBulletWitherEntity, EndTrollBulletRenderState> {
    ...
    @Override
    public void extractRenderState(EndTrollBulletWitherEntity entity, EndTrollBulletRenderState state, float partialTick) {
