...
public class EndTrollBulletDamageRenderer extends EntityRenderer<EndTrollBulletDamageEntity> {
    private static final Identifier END_TROLL_BULLET_TEXTURE = Identifier.fromNamespaceAndPath(Reference.MODID, "textures/entity/end_troll/bullets/end_troll_bullet_3.png");
    ...
    @Override
    public Identifier getTextureLocation(EndTrollBulletDamageEntity entity) {
