...
public class EndTrollBulletDamageEntity extends AbstractEndTrollBulletEntity {
    private static final DustParticleOptions RED_PARTICLE = new DustParticleOptions(0x8D0000, 1.0F);
    ...
    protected void onEntityHit(LivingEntity target) {
        // Additional damage
        target.hurtOrSimulate(this.damageSources().mobProjectile(this, this.owner), 8.0F);
    }
}
